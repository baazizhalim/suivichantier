...
@Database(entities = {Entreprise.class, Chantier.class, Lot.class, Plan.class,Mark.class, Photo.class, Remarque.class, PlanExecution.class, Pv.class, Communique.class}, version = 3,exportSchema=false)

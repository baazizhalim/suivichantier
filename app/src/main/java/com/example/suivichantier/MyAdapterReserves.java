...
public class MyAdapterReserves extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAdapterReserves(Context context,List<Mark> marks,int entrepriseID , String nomEntreprise , String typeEntreprise, String nomClient, String nomChantier , int chantierID) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeaderViewHolder) {
            ...
            switch(mark.getStatut()){
                case "SNT":itemHolder.itemText5.setBackgroundColor(ContextCompat.getColor(context, android.R.color.holo_red_light)); break;
           ...
           // itemHolder.lotID=plan.getLotID();
            ...
            itemHolder.itemText1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("lot",mark.getLot() );//type en detail
                    intent.putExtra("typeLot",plan.getDescription() );//4 types principaux
                    intent.putExtra("parentActivity","AnnexeReserves" );
